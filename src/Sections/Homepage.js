...
class HomePage extends React.Component {
  ...
  handleClick(e) {
    ...
    if (this.state.smallScrollActive) {
      ...
      this.smallScroll = gsap.to(this.scrollRef.current, {
        duration: 1 + Math.abs(this.state.splashscreen - num) / 2,
        ease: "power2",
  ...
  onComplete(which) {
    //which determines big vs small ani
    if (this.scrollRef.current.classList.contains("disabled")) {
      //avoid null errors
      this.scrollRef.current.classList.remove("disabled");
    }
    if (which === 1) {
      //set to 1 on small animation, set to 0 on big animation
  ...
  handleScroll(e) {
    if (
      this.scrollTimeline &&
      this.scrollTimeline.isActive() &&
      (e.deltaX > 1 || e.deltaX < -1)
    ) {
    ...
    this.scrollTimeline
      ...
      .to(
        this.scrollRef.current,
        {
          ...
          ease: "power2",
          scrollTo: {
            x: window.innerWidth * modifier * 2,
            autoKill: true,
            onAutoKill: () => this.onAutoKill,
          },
          overwrite: "auto",
      ...
      .to(
        this.scrollRef.current,
        {
          ...
          ease: "power2",
          scrollTo: {
            x: window.innerWidth * modifier * 3,
            autoKill: true,
            onAutoKill: () => this.onAutoKill,
          },
          overwrite: "auto",
    ...
    return (
      <>
        <div style={{ height: window.innerHeight * (8.9 / 10) }} id="HomePage">
          <div
            className="bg-white relative scroll-wrapper"
          ...
          <div
            className="bg-white w-full py-4 px-2 md:px-10 flex "
            style={{
              height:
                window.innerHeight * (9 / 10) -
                (window.innerHeight > 800 ? 496 : 450) +
                "px",
            }}
          >
            ...
            <div className="flex gap-2 gap-10 lg:gap-20 w-full justify-center my-auto">
              <div className=" m-x-6 ">
                <h1 className="text-xl text-red-500 underline text-center mb-1">
                  Designer
                </h1>
                <ul className="text-sm custom-list">
                  <li>
                    <a
                      target="_blank"
                      href="https://www.figma.com/file/7GH6pfk1eta5mPU1VMaPiY/Rough-Draft?node-id=0%3A1"
                      rel="noreferrer"
                    >
                      This website v.1: Wireframe
                    </a>
                  </li>
                  <li>
                    <a
                      target="_blank"
                      href="https://www.figma.com/file/9hWHeBCK5nTLdfsUAQ0jDy/Version-2%3A-Graphics?node-id=0%3A1"
                      rel="noreferrer"
                    >
                      This website v.2: Graphics
                    </a>
                  </li>
                  <li>
                    <a
                      target="_blank"
                      href="https://www.figma.com/file/F9F8Y5P0C5NN1I7sYWPs0S/Version-2-Projects?node-id=0%3A1"
                      rel="noreferrer"
                    >
                      This website v.2: Projects
                    </a>
                  </li>
                  <li>
                    <a
                      target="_blank"
                      href="https://www.figma.com/file/UtHcw20eYlovLgkc3s2rNt/Rough-Drafts?node-id=0%3A1"
                      rel="noreferrer"
                    >
                      Web Design Project
                    </a>
                  ...
                  <li>
                    <a
                      target="_blank"
                      href="https://www.figma.com/file/WMbla7u8locbCbJTy2Q3pa/Interactive-Grocery-Sharing-app?node-id=0%3A1"
                      rel="noreferrer"
                    >
                  ...
                  <li>
                    <a
                      target="_blank"
                      href="https://www.figma.com/file/pMcYJyOjqnLQg74RGUq31P/Wireframe?node-id=0%3A1"
                      rel="noreferrer"
                    >
                      Timer App Prototype
                    </a>
              ...
              <div className="m-x-6 ">
                <h1 className="text-xl text-green-500 underline text-center mb-1">
                  Engineer
                </h1>
                <ul className="text-sm custom-list">
                  <li>
                  ...
                  <li>
                    <a
                      target="_blank"
                      href="https://devpost.com/software/publix-transportation"
                    >
                      Inrix Hack Submission
                    </a>
                  </li>
                  <li>
                    <a
                      target="_blank"
                      href="https://www.scu.edu/engineering/academic-programs/department-of-mechanical-engineering/undergraduate/course-descriptions/"
                    >
                  ...
                  <li>
                    <a
                      target="_blank"
                      href="https://www.engr.scu.edu/~emaurer/classes/ceng41_statics/syllabus.shtml"
                    >
                      Ceng 41: Statics
                    </a>
                  </li>
                  <li>
                    <a
                      target="_blank"
                      href="https://www.scu.edu/media/school-of-engineering/pdfs/mechanical-engineering/MECH-143.pdf"
                    >
                  ...
                  <li>
                    <a
                      target="_blank"
                      href="https://www.cse.scu.edu/~atkinson/teaching/sp20/012/"
                    >
                      Coen 12: Abstract Data Types
                    </a>
                  </li>
                </ul>
              </div>
              <div className="m-x-6 ">
                <h1 className="text-xl text-blue-500 underline text-center mb-1">
                  Student
                </h1>
                <ul className="text-sm custom-list">
                  <li>
                    <a target="_blank" href="https://scuakpsi.com/">
                  ...
                  <li>
                    <a
                      target="_blank"
                      href="https://www.freecodecamp.org/certification/fccb3105040-9dfe-4763-868b-cc9349a80f00/javascript-algorithms-and-data-structures"
                    >
                      Free Code Camp JS Certificate
                    </a>
                  </li>
                  <li>
                    <a
                      target="_blank"
                      href="http://www.applmath.engr.scu.edu/~garrison/AMTH108-S05/amth108.html"
                    >
                      Amth 108: Probability
                    </a>
                  </li>
                  <li>
                    <a
                      target="_blank"
                      href="https://www.scu.edu/engineering/academic-programs/general-engineering/undergraduate/course-descriptions/"
                    >
                      Engr 19: Ethics in Tech
                    </a>
                  </li>
                  <li>
                    <a
                      target="_blank"
                      href="https://www.scu.edu/bulletin/undergraduate/chapter-3/English.html"
                    >
                      Engl 181: Eng. Communications
                    </a>
                  </li>
                  <li>
                    Currently Learning:{" "}
                    <a target="_blank" href="https://rxjs.dev/">
                      RxJS
                    </a>{" "}
                  </li>
                </ul>
